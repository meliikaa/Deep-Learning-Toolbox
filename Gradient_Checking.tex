...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{x}\PY{p}{,} \PY{n}{theta} \PY{o}{=} \PY{l+m+mi}{3}\PY{p}{,} \PY{l+m+mi}{4}
...
\PY{k}{def} \PY{n+nf}{gradient\PYZus{}check}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{theta}\PY{p}{,} \PY{n}{epsilon}\PY{o}{=}\PY{l+m+mf}{1e\PYZhy{}7}\PY{p}{,} \PY{n}{print\PYZus{}msg}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}\PY{p}{:}
    \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
\PY{l+s+sd}{    Implement the gradient checking presented in Figure 1.}
\PY{l+s+sd}{    }
\PY{l+s+sd}{    Arguments:}
...
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    ...
    \PY{c+c1}{\PYZsh{} Compute gradapprox using right side of formula (1). epsilon is small enough, you don\PYZsq{}t need to worry about the limit.}
    \PY{c+c1}{\PYZsh{} (approx. 5 lines)}
    \PY{c+c1}{\PYZsh{} theta\PYZus{}plus =                                 \PYZsh{} Step 1}
    \PY{c+c1}{\PYZsh{} theta\PYZus{}minus =                                \PYZsh{} Step 2}
    \PY{c+c1}{\PYZsh{} J\PYZus{}plus =                                    \PYZsh{} Step 3}
    \PY{c+c1}{\PYZsh{} J\PYZus{}minus =                                   \PYZsh{} Step 4}
    \PY{c+c1}{\PYZsh{} gradapprox =                                \PYZsh{} Step 5}
    \PY{c+c1}{\PYZsh{} YOUR CODE STARTS HERE}
    \PY{n}{theta\PYZus{}plus}  \PY{o}{=} \PY{n}{theta} \PY{o}{+} \PY{n}{epsilon}                                
    \PY{n}{theta\PYZus{}minus} \PY{o}{=} \PY{n}{theta} \PY{o}{\PYZhy{}} \PY{n}{epsilon}                               
    \PY{n}{J\PYZus{}plus}      \PY{o}{=} \PY{n}{theta\PYZus{}plus}  \PY{o}{*} \PY{n}{x}                                
    \PY{n}{J\PYZus{}minus}     \PY{o}{=} \PY{n}{theta\PYZus{}minus} \PY{o}{*} \PY{n}{x}                                  
    \PY{n}{gradapprox}  \PY{o}{=} \PY{p}{(}\PY{n}{J\PYZus{}plus}\PY{o}{\PYZhy{}}\PY{n}{J\PYZus{}minus}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{epsilon}\PY{p}{)}                               
        
    \PY{c+c1}{\PYZsh{} Check if gradapprox is close enough to the output of backward\PYZus{}propagation()}
    \PY{c+c1}{\PYZsh{}(approx. 1 line) DO NOT USE \PYZdq{}grad = gradapprox\PYZdq{}}
    \PY{c+c1}{\PYZsh{} grad =}
    \PY{c+c1}{\PYZsh{} YOUR CODE STARTS HERE}
    ...
    \PY{c+c1}{\PYZsh{} numerator =                                 \PYZsh{} Step 1\PYZsq{}}
    \PY{c+c1}{\PYZsh{} denominator =                               \PYZsh{} Step 2\PYZsq{}}
    \PY{c+c1}{\PYZsh{} difference =                                \PYZsh{} Step 3\PYZsq{}}
    \PY{c+c1}{\PYZsh{} YOUR CODE STARTS HERE}
    \PY{n}{numerator}   \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{norm}\PY{p}{(}\PY{n}{grad} \PY{o}{\PYZhy{}} \PY{n}{gradapprox}\PY{p}{)}                               
    \PY{n}{denominator} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{norm}\PY{p}{(}\PY{n}{grad}\PY{p}{)} \PY{o}{+} \PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{norm}\PY{p}{(}\PY{n}{gradapprox}\PY{p}{)}                             
    \PY{n}{difference}  \PY{o}{=} \PY{n}{numerator} \PY{o}{/}  \PY{n}{denominator}
...
difference = 7.814075313343006e-11
    ...
    Congrats, the difference is smaller than the \(2 * 10^{-7}\) threshold.
So you can have high confidence that you've correctly computed the
gradient in \texttt{backward\_propagation()}.
...
\PY{l+s+sd}{    }
\PY{l+s+sd}{    Returns:}
\PY{l+s+sd}{    cost \PYZhy{}\PYZhy{} the cost function (logistic cost for m examples)}
...
\PY{l+s+sd}{    X \PYZhy{}\PYZhy{} input datapoint, of shape (input size, number of examples)}
\PY{l+s+sd}{    Y \PYZhy{}\PYZhy{} true \PYZdq{}label\PYZdq{}}
\PY{l+s+sd}{    epsilon \PYZhy{}\PYZhy{} tiny shift to the input to compute approximated gradient with formula(1)}
\PY{l+s+sd}{    }
\PY{l+s+sd}{    Returns:}
...
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    ...
    \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{num\PYZus{}parameters}\PY{p}{)}\PY{p}{:}
        ...
        \PY{c+c1}{\PYZsh{} \PYZdq{}\PYZus{}\PYZdq{} is used because the function you have outputs two parameters but we only care about the first one}
        \PY{c+c1}{\PYZsh{}(approx. 3 lines)}
        ...
        \PY{n}{J\PYZus{}minus}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{,} \PY{n}{\PYZus{}} \PY{o}{=} \PY{n}{forward\PYZus{}propagation\PYZus{}n}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{Y}\PY{p}{,} \PY{n}{vector\PYZus{}to\PYZus{}dictionary}\PY{p}{(}\PY{n}{theta\PYZus{}minus}\PY{p}{)}\PY{p}{)}     
        \PY{c+c1}{\PYZsh{} YOUR CODE STARTS HERE}
